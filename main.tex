...
\columnbreak
\normalsize\par{\centering{\Large\textsc{\textcolor{primary}{Aditya} Vikram Singh}}} % Your name
\vspace{-0.1cm}
...
\textsc{May 2019}& {- Designed and Created the \href{https://finbox.in/}{website (finbox.in)} of FinBox}\\
