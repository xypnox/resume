...
\definecolor{default}{RGB}{50, 50, 50}
\definecolor{linkcolour}{RGB}{168,44,79}
...
\textsc{Programming} & \textit{Proficient:} Python, Frontend\\
& \textit{Competent:} C, C++, JavaScript, Rust, Golang, Haskell \\
