...
\columnbreak
\normalsize\par{\centering{\huge\textsc{\textcolor{primary}{Aditya} Vikram Singh}}\par} % Your name
...
\textsc{May} & \textbf{Assistant Tech Coordinator}\hfill\textbf{Gymkhana IIT Kharagpur}\\
